...
options(warn=-1)
getBob2022HabResults <- function(results_list, bob_2022_hab, example){
  tryCatch(
    expr = {
      ...
      source("scripts/bob/edd/getBob2022HabResultsUnitLookup.R")
      ...
      message(
        if(length(check_df$result == "MATCH") == nrow(check_df)){
          "`getBob2022HabResults()` executed successfully..."
        } else {
